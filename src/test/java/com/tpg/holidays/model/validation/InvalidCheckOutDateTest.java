...
public class InvalidCheckOutDateTest extends SearchRequestValidationTest {

    @Test
    public void shouldDetectNullValue() {

        SearchRequest searchRequest = searchRequest("London", "26/12/2018", null,2,
                singletonList(8), 1);
        ...
        assertViolation(violation, "may not be empty", "checkOut", null);
    }
    ...
    public void shouldDetectEmptyValue() {
        ...
        assertViolation(violation, "may not be empty", "checkOut", "");
    }
}
